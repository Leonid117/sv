...
var allMods5 = $(".services .inner h2");
var allMods6 = $(".services .inner .serivces_content");
var allMods7 = $(".services .models h2");
var allMods8 = $(".services .models .models_content .m_col");
var allMods9 = $(".platform .platform_content");
var allMods10 = $(".platform .platform_content .circle");
...
$(document).ready(function () {
    var $tsdiv = $('.platform .platform_content');
    if($tsdiv.hasClass('come-in')){
        $('.platform .platform_content .circle').addClass('animate');
    }
    else{
...
$(document).ready(function () {
    var interval;
    var timer = function(){
    var $children = $(".brand_tab_content .brand_images a.filtered");
    ...
    $('.brands .brand_tab_title ul li a').click(function(){
